...
install_if_missing sublime-text cask "Sublime Text - Code editor"
install_if_missing adobe-acrobat-reader cask "Adobe Acrobat Reader - PDF reader"
install_if_missing onlyoffice cask "ONLYOFFICE - Office suite"
